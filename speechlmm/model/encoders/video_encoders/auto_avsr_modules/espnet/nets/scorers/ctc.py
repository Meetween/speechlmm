...
from speechlmm.model.encoders.video_encoders.auto_avsr_modules.espnet.nets.ctc_prefix_score import (
    CTCPrefixScore,
    CTCPrefixScoreTH,
)
...
class CTCPrefixScorer(BatchPartialScorerInterface):
    ...
    def init_state(self, x: torch.Tensor):
        ...
        """
        logp = (
            self.ctc.log_softmax(x.unsqueeze(0))
            .detach()
            .squeeze(0)
            .cpu()
            .numpy()
