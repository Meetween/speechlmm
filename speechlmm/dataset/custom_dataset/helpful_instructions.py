...
class HelpfulInstructionsDataset(CustomDataset):
    name = "HelpfulInstructions"
    codename = "helpful_instructions"
    remap_keys = {"demonstration": "output"}

    optional_filters = [NUM_WORDS_FILTER]
    text_keys = ["demonstration", "instruction"]
